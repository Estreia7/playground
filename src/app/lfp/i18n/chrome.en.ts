...
export const chromeEn: ChromeDict = {
  nav: {
    ...
    close: "Close",
    home: "Home",
    hubAll: "See everything in {section}",
    sections: {
    ...
    items: {
      ...
      irs: "Income tax",
      tsu: "Social Security",
      recibosVerdes: "Freelancing",
      cenarios: "Compare scenarios",
      custoTrabalhador: "Cost of an employee",
      iva: "VAT",
      irc: "Corporate tax",
      inflacao: "Time machine",
      juros: "Compound interest",
      impostos: "Taxpayer receipt",
      dias: "Days of work",
      aumento: "Raise vs. inflation",
      situas: "Where you stand",
      casa: "Cost of a house",
      cesto: "VAT receipt",
      vida: "Life timeline",
      orcamento: "Household budget",
      quiz: "Quiz",
      mitos: "Tax myths",
      perfil: "Your progress",
      sobre: "About and sources",
  ...
  share: {
    ...
    hint: "The link opens the same calculation, with this card.",
    copy: "Copy link",
    copied: "Link copied",
    native: "Share…",
    alt: "Share card",
    siteName: "Portuguese Financial Literacy",
    legalShort: "No legal standing",
    legalYear: "{year} data · no legal standing",
    sourceLabel: "Source:",
    cards: {
      salarioEyebrow: "Of {bruto} gross salary, this lands in your account",
      salarioSub: "per month, single, no dependants, mainland",
      effective: "Effective income-tax rate",
      inflacaoEyebrow: "{amount} from {from} is worth today",
      inflacaoSub: "in {to} euros, by the rise in prices",
      priceRise: "Price increase",
      multiplier: "Multiplier",
      diasEyebrow: "In Portugal, {price} costs",
      day: "day of work",
      days: "days of work",
      diasSubPps: "of average net pay, in purchasing power",
      diasSubEur: "of average net pay, in nominal euros",
      daily: "One day of net work",
      quizEyebrow: "Financial literacy quiz · {mode}",
      score: "Score",
      quizSource: "Questions with official sources, playground.bruno-dev.xyz/lfp",
    },
  },
