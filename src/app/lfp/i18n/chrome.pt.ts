...
export const chromePt = {
  nav: {
    ...
    langLabel: "Idioma",
    trailLabel: "Onde estás",
    menuLabel: "Navegação principal",
    open: "Menu",
    close: "Fechar",
    home: "Início",
    hubAll: "Ver tudo em {section}",
    sections: {
    ...
    items: {
      ...
      cenarios: "Comparar cenários",
      custoTrabalhador: "Custo de um trabalhador",
      iva: "IVA",
      irc: "IRC",
      inflacao: "Máquina do tempo",
      juros: "Juros compostos",
      impostos: "Recibo do contribuinte",
      dias: "Dias de trabalho",
      aumento: "Aumento vs. inflação",
      situas: "Onde te situas",
      casa: "Custo de uma casa",
      cesto: "Recibo de IVA",
      vida: "Linha da vida",
      orcamento: "Orçamento familiar",
      quiz: "Quiz",
      mitos: "Mitos fiscais",
      perfil: "O teu progresso",
      sobre: "Sobre e fontes",
